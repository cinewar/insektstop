...
export function EnlargedImageGalery({
  ...
  return (
    <div className='fixed inset-0 z-50 flex items-center justify-center px-1 bg-black/15 backdrop-blur-sm bg-opacity-75'>
      <button
        type='button'
        onClick={handlePrev}
      ...
      {hasImages && (
        <div className='w-full aspect-square relative border border-primary rounded-2xl shadow-custom '>
          <Svg
            icon={CLOSESVG}
            size={32}
